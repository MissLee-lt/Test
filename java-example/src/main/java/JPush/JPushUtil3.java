...
public class JPushUtil3 implements StreamRequestHandler, FunctionInitializer{
	...
	public static PushResult jpushAndroid(Map<String, String> parm) {
		...
		// 推送的关键，构造一个payload（message是推送无通知的消息）		
...
//		map.put("title", json.getString("title"));
		PushResult pu = JPushUtil3.jpushAndroid(map);
