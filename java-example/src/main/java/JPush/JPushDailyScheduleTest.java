...
public class JPushDailyScheduleTest implements StreamRequestHandler, FunctionInitializer {

	protected static final Logger LOG = LoggerFactory.getLogger(JPushDailyScheduleTest.class);
	...
	public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
		JPushDailyScheduleTest jpushScheduleTest2 = new JPushDailyScheduleTest();
	...
	public void testCreateDailySchedule(Map<String, String> map) {
		...
		try {
			ScheduleResult result = jpushClient.createDailySchedule(map.get("name"), map.get("start"), map.get("end"), map.get("time"), push);
	...
	public Map<String, String> inputToMap(InputStream input) {
		...
		map.put("end", json.getString("end"));
